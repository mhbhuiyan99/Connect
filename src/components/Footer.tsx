...
export default function Footer() {
    return (
        <footer id="colophon" className="site-footer bg-cover bg-center bg-no-repeat text-white py-14" style={{ backgroundImage: 'url("https://cdn-ilddgbh.nitrocdn.com/KCiiUwRzwPIrRDjogfTRMgHMpGyyzAgg/assets/images/optimized/rev-f7111be/mbstu.ac.bd/wp-content/uploads/2022/10/Mbstu-Footer.jpg")' }}>
            <div className="container mx-auto px-4">
                <div className="row flex flex-col md:flex-row justify-between">
                    ...
                    */}
                    ...
                    <div className="mb-6 md:mb-0 w-full md:w-1/4">
                        ...
                        <ul className="space-y-2 text-sm text-gray-400">
                            <li><Link href="/bhashani/ict-cell/" target="_blank" rel="nofollow">ICT Cell</Link></li>
                            <li><Link href="/bncc/" target="_blank" rel="nofollow">BNCC</Link></li>
                            <li><Link href="/central-library/" target="_blank" rel="nofollow">Central Library</Link></li>
                            <li><Link href="/residential-halls/" target="_blank" rel="nofollow">Residential Halls</Link></li>
                            <li><Link href="/students-welfare-and-counseling/" target="_blank" rel="nofollow">Students’ Welfare and Counseling</Link></li>
                            <li><Link href="/registrar-office/" target="_blank" rel="nofollow">Registrar Office</Link></li>
                            <li><Link href="/research-cell/" target="_blank" rel="nofollow">Research Cell</Link></li>
                        </ul>
                    </div>
                    ...
                    <div className="mb-6 md:mb-0 w-full md:w-1/4">
                        ...
                        <ul className="space-y-2 text-sm text-gray-300">
                            <li className="flex items-center"><span className="text-red-500 mr-2">✉️</span> alumni@mbstu.ac.bd</li>
                            <li className="flex items-center"><span className="text-red-500 mr-2">📞</span> +880921 55399</li>
                            <li className="flex items-center"><span className="text-red-500 mr-2">📞</span> +880921 55399</li>
                        </ul>
                ...
                <div className="mt-6 pt-4 border-t border-gray-500 flex flex-col md:flex-row justify-center items-center">
                    <div className="mb-4 md:mb-0">
                        <Link href="https://mbstu.ac.bd/" className="text-sm text-white hover:text-gray-300">
