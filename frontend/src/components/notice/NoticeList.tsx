...
export default function NoticeList({ notices, page, limit }: { notices: Notice[]; page: number; limit: number }) {
  return (
          ...
          <div
            ...
            <div className="flex items-center mb-4">
              <div className="flex-shrink-0">
                <Image
                  src={notice.author_profile_photo || "/default_user.png"}
            ...
            <h3 className="text-xl font-semibold mb-2">
              {notices.indexOf(notice) + 1 + (page - 1) * limit}. {notice.title}
            </h3>
