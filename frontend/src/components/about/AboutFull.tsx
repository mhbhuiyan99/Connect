...
export default async function AboutFull() {
  return (
    <div className="space-y-12">
      ...
      <section className="max-w-4xl mx-auto px-6">
        ...
        <p className="text-gray-700 leading-relaxed text-justify">
          ...
          members through professional events and service to MBSTU,CSE and society. 
        </p>
      </section>
      ...
      <section className="bg-gray-50 py-12">
        <div className="max-w-3xl mx-auto px-6 text-center">
          ...
          <p className="text-gray-700 leading-relaxed">
            <strong>Mission:</strong> Unite MBSTU,CSE alumni globally to further professional excellence
            and innovation—and enhance student success through networking.
          </p>
