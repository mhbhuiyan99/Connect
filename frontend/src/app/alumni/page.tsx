...
import { searchAlumni } from "@/lib/api/alumni";

type FilterKey = "name" | "skills" | "company" | "student_id" | "hometown";
...
export default function AlumniViewPage() {
  ...
  useEffect(() => {
    const fetchAlumni = async () => {
      ...
      setAlumni([]);
      try {
        const data = await searchAlumni(debouncedSearchTerm, filterBy, 1, 100);
